...
\end{definition}
%
\textbf{vogliamo togliere $\hat{y}_i = \hat{y}_j = o $ dalla def, visto che è implicito nella nuova definizione di $\mathcal{Z}^s_o$?}
...
\end{definition}
%
\textbf{anche qua, vogliamo togliere $\wedge \hat{y}_i = \hat{y}_j = \hat{y}_l = o$?}
